...
B1: Vào khu vực "Công xưởng" của Cloudflare
...
1.Bạn hãy click chuột thẳng vào chữ Get started (được in đậm và gạch chân màu đen) đó.

2.Ngay khi bấm vào chữ Get started, màn hình sẽ chuyển sang giao diện chuẩn của Pages. Lúc này, bạn sẽ thấy một tab có chữ Pages và nút Connect to Git (Kết nối với Git) quen thuộc hiện ra.

3.Chọn nguồn nhập dữ liệu: Tại ô đầu tiên có dòng chữ Import an existing Git repository (Nhập một kho Git có sẵn), bạn hãy bấm vào nút Get started màu xanh ở bên phải của ô đó.

![tai-xuong-(2).png](https://i.postimg.cc/DwSrkfry/tai-xuong-(2).png)

4.Chọn kho GitHub: Màn hình tiếp theo sẽ hiện ra danh sách tài khoản GitHub của bạn. Bạn hãy tích chọn đúng kho duyhungmdh/lotusdocs và bấm nút Begin setup (Bắt đầu cài đặt).

![tai-xuong-(4).png](https://i.postimg.cc/MZmsDYbR/tai-xuong-(4).png)

Thiết lập thông số xây dựng web (Bước quyết định):
